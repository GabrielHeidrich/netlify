        ...
        <main>
                ...
                <section className="even-columns">
                    <div className="card">
                        ...
                        <div>
                            ...
                            <p>
                                Atendemos cães, gatos e até pets exóticos!<br />Cada um recebe atenção personalizada, respeitando suas necessidades e temperamento.
                            </p>
                            <hr />
                        </div>
                    </div>
                    <div className="card">
                        ...
                        <div>
                            ...
                            <p>
                                Utilizamos produtos dermatologicamente testados e técnicas de relaxamento para garantir o conforto e bem-estar do seu pet.
                            </p>
                            <hr />
                        </div>
                    </div>
                    <div className="card">
                        ...
                        <div>
                            ...
                            <p>
                                Nossa equipe é formada por profissionais apaixonados e certificados, sempre atualizados nas melhores práticas de estética e saúde animal. Cuidar do seu pet é nossa vocação.
                            </p>
                            <hr />
                        </div>
                    </div>
            ...
            <section id="testimonials">
                <header>
                    ...
                    <p>
                        Quem já trouxe seu pet pra <strong>PetCare</strong> sabe:
                        aqui cada banho, tosa e carinho são feitos com amor e
                        profissionalismo. Veja o que nossos clientes dizem sobre a experiência!
                    </p>
                </header>
                ...
                <section className="carousel">
                    ...
                    <div className="carousel-content">
                        ...
                        <div className="carousel-card">
                            ...
                            <span className="testimony">
                                <p>
                                    Levei meu golden pra tosa e o resultado foi incrível! O pelo ficou
                                    macio, cheiroso e ele saiu abanando o rabo de alegria.
                                </p>
                            </span>
                        ...
                        <div className="carousel-card">
                            ...
                            <span className="testimony">
                                <p>
                                    ...
                                    tratam os animais com tanto carinho que meu pug nem quis ir embora.
                                </p>
                            </span>
                            <span className="rating" aria-label="4 de 5 estrelas">
                                <img src={Star} alt="estrela" width={22} height={20} />
                    ...
                    <div className="carousel-content">
                        <div className="carousel-card">
                            ...
                            <span className="testimony">
                                <p>
                                    Atendimento incrível e qualidade excelente. Recomendo para quem
                                    quer praticidade.
                                </p>
                            </span>
                            <span className="rating" aria-label="4 de 5 estrelas">
                        ...
                        <div className="carousel-card">
                            ...
                            <span className="testimony">
                                <p>
                                    ...
                                    super calmo! Dá pra ver que eles entendem de verdade sobre pets.
                                </p>
                            </span>
                            <span className="rating" aria-label="4 de 5 estrelas">
                                <img src={Star} alt="estrela" width={22} height={20} />
            ...
            <section id="pricing" className="container">
                ...
                <section className="even-columns gap-1.5">
                    ...
                    <div className="pricing-card premium" aria-label="Plano Premium">
                        ...
                        <span className="plan">
                            <h3>Premium</h3>
                            <p>Para quem quer manter o pet sempre limpo, cheiroso e bem cuidado, com total comodidade.</p>
                        </span>
            ...
            <footer id="footer">
                <section className="footer-content container">
                    ...
                    <div className="footer-column">
                        <h4>Recursos</h4>
                        <ul>
                            <li><a href="#">App PetCare</a></li>
                            <li><a href="#">Agendar serviço</a></li>
                ...
                <section className="footer-bottom">
                    <p>
                        Feito com amor na aula de <strong>Programação Web</strong> 💙<br />
